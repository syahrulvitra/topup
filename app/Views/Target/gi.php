<div class="form-row pt-3">
    <div class="col">
        <input type="text" name="user_id" id="user_id" class="form-control" placeholder="Masukkan User ID" autocomplete="off">
    </div>
    <div class="col">
                              <select name="zone_id" id="zone_id" class="form-control" autocomplete="off">
